...
export default function TermsOfService() {
    ...
    return (
        <main className="min-h-screen flex flex-col bg-pattern-crosses">
            <Nav />
            <div className="mx-auto w-full max-w-4xl px-6 pb-24 pt-32 md:pt-40 flex-grow">
                <div className="tm-animate-fade-up space-y-12">
                    <section className="rounded-[28px] border border-slate/30 bg-midnight/80 backdrop-blur-sm px-6 py-12 md:px-10">
                        <div className="text-xs font-semibold uppercase tracking-wider text-muted">
                            Legal
                        </div>
                        <h1 className="mt-3 text-4xl font-display font-bold tracking-tight sm:text-5xl text-paper">
                            Terms of Service
                        </h1>
                        ...
                        <div className="mt-8 text-sm text-muted font-mono">
                    ...
                    <div className="space-y-10 px-2 md:px-6">
                        <section className="space-y-4">
                            <h2 className="text-2xl font-display font-bold tracking-tight text-paper">
                            ...
                            <p className="text-sm leading-relaxed text-muted">
                                ...
                                <a
                                    href={siteConfig.url}
                                    className="font-medium text-gold hover:text-paper transition-colors underline underline-offset-4"
                                >
                                    {siteConfig.domain}
                                </a>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-4 text-sm leading-relaxed text-muted">
                                ...
                                <ul className="list-inside list-disc space-y-2 marker:text-gold">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="mt-4 space-y-1 text-sm text-muted font-mono">
                                <div className="font-bold text-paper font-sans">
                                    {siteConfig.name}
                                </div>
                                ...
                                <div>
                                    ...
                                    <a
                                        ...
                                        className="text-gold hover:text-paper transition-colors underline underline-offset-4"
                                    >
                                        {siteConfig.email}
                                    </a>
                                </div>
