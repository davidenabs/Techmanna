...
export function TrustTicker() {
  ...
  return (
    <div className="w-full py-12 flex flex-col items-center overflow-hidden border-b border-slate/30 bg-linear-to-b from-transparent to-midnight/50">
      ...
      <div className="trust-ticker-container max-w-[50vw]">
